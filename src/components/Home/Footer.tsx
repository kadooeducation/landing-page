        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-8">
              {/* Instagram */}
              <a href="https://www.instagram.com/kadooedu?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="w-10 h-10 bg-[#1F1F27] rounded-lg flex items-center justify-center hover:bg-[#6B47ED] transition-all group">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/kadooedu/" className="w-10 h-10 bg-[#1F1F27] rounded-lg flex items-center justify-center hover:bg-[#6B47ED] transition-all group">
